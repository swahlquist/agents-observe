...
```
Agent(
  prompt="Read /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/templates/SECURITY.md`
