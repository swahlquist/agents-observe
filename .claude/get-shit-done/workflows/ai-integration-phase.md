...
<required_reading>
@/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/references/ai-frameworks.md
@/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/agents/gsd-eval-planner.md for instructions.
