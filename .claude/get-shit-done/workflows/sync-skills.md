...
INSTALL_JS_GLOBAL="/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
