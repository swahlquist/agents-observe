...
```bash
INIT=$(node "/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/templates/spec.md.
