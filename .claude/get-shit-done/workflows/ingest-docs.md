...
```bash
INIT=$(node "/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
