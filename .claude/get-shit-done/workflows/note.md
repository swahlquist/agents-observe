...
- **Global scope**: `/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/notes/`)
...
2. Glob `/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/notes/` — works in any directory
