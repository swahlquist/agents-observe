...
```
Agent(
  prompt="Read /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/templates/VALIDATION.md`
