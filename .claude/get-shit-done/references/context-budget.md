...
The keys live in `.claude/settings.json` (project) or `/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/settings.json` (global) — **not** in `.planning/config.json`:
