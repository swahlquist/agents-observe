...
- Usage: Reference from command with `@/home/scotw/ai-company-brain/dashboard/agents-observe/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/scotw/ai-company-brain/dashboard/agents-observe/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
